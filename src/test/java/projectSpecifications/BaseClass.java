...
public class BaseClass {
	...
	public static String logfile = Paths.get("src", "test", "java", "utils", "Log4j.properties").toAbsolutePath()
			.toString();

	// Test data location
	public static String excelfilename = Paths.get("TestData", "MGFF_TestData.xlsx").toAbsolutePath().toString();
